...
public class AnnouncementService {
    ...
    public List<AnnouncementDto> getAllAnnouncementsPagination(UserDetailsImpl userDetails, int offset, int limit, Integer classId) {
        ...
        if (classId != null) {
            ...
            List<Announcement> announcements = announcementRepository.findByCreatorSchoolIdAndClassesIsNullOrClassesIn(userDetails.getUserRole().getSchool().getId(), List.of(classId), PageRequest.of(offset, limit));
