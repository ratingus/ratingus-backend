...
//        return ResponseEntity.ok(new AnnouncementDto(announcement.getId(), announcement.getContent(), announcement.getContent(), announcement.getCreator(), announcement.getClasses()));
